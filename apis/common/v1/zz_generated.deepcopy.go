...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedCrossplane) DeepCopyInto(out *ManagedCrossplane) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedCrossplane.
func (in *ManagedCrossplane) DeepCopy() *ManagedCrossplane {
	if in == nil {
		return nil
	}
	out := new(ManagedCrossplane)
	in.DeepCopyInto(out)
	return out
}
